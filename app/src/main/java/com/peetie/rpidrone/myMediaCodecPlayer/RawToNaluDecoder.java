package com.peetie.rpidrone.myMediaCodecPlayer;
...
Edited by Peter Schoenau to have an integrated wifibroadcast
 */
...
public class RawToNaluDecoder { public volatile boolean next_frame=false;
    ...
    public RawToNaluDecoder(Surface surface1, int port, Context context) {
        surface=surface1;
        mContext = context;
        this.port = port;
